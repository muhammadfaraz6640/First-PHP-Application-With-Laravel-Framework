...
<!-- @csrf instead of csrf you can add in exception in middleware>verifycsrftoken -->
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleFormControlInput1" name="title" value="{{old('title', $article->Title)}}" placeholder="Title of Book">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleFormControlInput2" name="author" value="{{old('author',$article->Author)}}" placeholder="Author of Book">
    @if($errors->any())
  ...
  <input type="submit" class="btn btn-primary" value="Update" name="add" id="add">
</form>
